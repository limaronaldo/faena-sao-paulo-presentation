#!/usr/bin/env python3
"""
Capture the /print route (no snap-scroll, fixed 810px slides) as a tall screenshot,
...
OUTPUT = "Pinna5109-MBRAS-Parceria.pdf"
SLIDES = 11
WIDTH = 1440
HEIGHT = 810
TMPDIR = "/tmp/pinna-slides"
...
TOTAL_H = HEIGHT * SLIDES  # 8910px total
