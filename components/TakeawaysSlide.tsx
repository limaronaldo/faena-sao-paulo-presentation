...
export default function TakeawaysSlide() {
    ...
    return (
        <Slide className="bg-cream-200 text-text-primary">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-center px-8 md:px-16 py-12">
                <motion.h2
                ...
                <motion.p
                    ...
                    className="text-sm md:text-base text-text-secondary leading-relaxed max-w-xl mb-10 whitespace-pre-line"
                >
                    {takeaways.intro}
                </motion.p>
